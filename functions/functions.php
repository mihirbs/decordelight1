...
function getProductsByCategory($p_cat_id) {
  global $db;

  // Sanitize the input (to prevent SQL injection)
  $safe_p_cat_id = mysqli_real_escape_string($db, $p_cat_id);

  // Fetch products based on the provided p_cat_id
  $get_products = "SELECT * FROM products WHERE p_cat_id = '$safe_p_cat_id' ORDER BY product_id DESC";
  $run_products = mysqli_query($db, $get_products);

  while ($row_products = mysqli_fetch_array($run_products)) {
      // Extract product details (similar to your existing getPro function)
      $pro_id = $row_products['product_id'];
...
";
      ...
      // Display the products as needed
      // Example: $pro_id = $row_products['product_id'];
      // ...
  }
}
